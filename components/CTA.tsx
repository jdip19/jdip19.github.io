  ...
  return (
    <section className="py-24 sm:py-32">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-orange-500 to-orange-600 p-12 sm:p-16 text-center">
          {/* Background decoration */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute -top-20 -left-20 w-72 h-72 rounded-full bg-white opacity-5 blur-2xl" />
            <div className="absolute -bottom-16 -right-16 w-64 h-64 rounded-full bg-orange-400 opacity-30 blur-2xl" />
            <div
          ...
          <div className="relative">
            ...
            <p className="text-orange-100 text-lg sm:text-xl max-w-xl mx-auto mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="#products"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white text-orange-600 font-semibold text-base hover:bg-orange-50 transition-all duration-200 shadow-lg hover:-translate-y-0.5"
              >
                Explore All Tools
            ...
            <div className="mt-14 pt-10 border-t border-white/20 grid grid-cols-3 gap-8 max-w-lg mx-auto">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <div className="text-orange-200 text-xs tracking-wide">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
